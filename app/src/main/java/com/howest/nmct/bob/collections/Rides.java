...
public class Rides {
    ...
    public static void fetchData() {
        ...
        Ride gentseRide = new Ride("2", "2", "Gentse Feesten", "one day", "Korenmarkt, Gent");
        ...
        Ride randomRide = new Ride("3", "1", "An event for great and spectacularious amazeballs photography with your fabulous unicorn!!! \uD83D\uDE04 \uD83D\uDC34 \uD83D\uDE04 \uD83D\uDC34 ", "one week", "Somewhere in '); DROP TABLE city;");
        randomRide.setDriver(new User("3", "Bob Dylan"));

        Ride approvedRide = new Ride("4", "2", "Approved event", "2 hours", "Graaf Karel de Goedelaan 38, 8500 Kortrijk");
